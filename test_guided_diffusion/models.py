...
class TemporalUnet_jayaram(nn.Module):
...
class ValueFunction(nn.Module):
    ...
    def __init__(
        ...
        dims = [transition_dim, *map(lambda m: dim * m, dim_mults)]  #[23, 32, 128, 256]
        in_out = list(zip(dims[:-1], dims[1:]))   #[(23, 32), (32, 128), (128, 256)]
        ...
        mid_dim = dims[-1]   #256
        mid_dim_2 = mid_dim // 2   #128
        mid_dim_3 = mid_dim // 4  #64
        ##
        ...
        horizon = horizon // 4  #(remove this comment later)  this affects wts dimension
        ##
